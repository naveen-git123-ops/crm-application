    ...
    <div className="space-y-6" data-testid="employees-page">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredEmployees.map((employee) => (
          <Card key={employee.id} className="p-6 card-hover" data-testid={`employee-card-${employee.employee_id}`}>
            <div className="space-y-4">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">{employee.job_role}</p>
                </div>
              ...
              <div className="pt-4 border-t border-border flex justify-between items-center">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm font-mono font-medium">₹{employee.salary.toLocaleString()}</p>
                </div>
              </div>
